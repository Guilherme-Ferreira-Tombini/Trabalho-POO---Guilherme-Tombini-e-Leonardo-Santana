...
public class App {
    ...
    private static Pessoa usuario = new Pessoa("João Silva", "999.999.999-99", "joao@email.com", "1234");
    ...
    public static void main(String[] args) {
        ...
        if (realizarLogin()) {
            ...
            do {
                ...
                String input = JOptionPane.showInputDialog(null, menu, "Menu de Reservas",
            ...
            JOptionPane.showMessageDialog(null, "Encerrando o programa.", "Erro",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private static boolean realizarLogin() {
        while (true) {
            String email = JOptionPane.showInputDialog(null, "Digite seu email:", "Login",
                    JOptionPane.QUESTION_MESSAGE);
            String senha = JOptionPane.showInputDialog(null, "Digite sua senha:", "Login",
                    JOptionPane.QUESTION_MESSAGE);

            // Verifica se o usuário cancelou o login
            if (email == null || senha == null) {
                JOptionPane.showMessageDialog(null, "Login cancelado.", "Cancelamento",
                        JOptionPane.INFORMATION_MESSAGE);
                return false;
            }
